...
{
    public class KondukterProdajeViewModel
    {
        ...
        KondukterViewModel model;
        Kondukter selected;
        KondukterProdajeView view = null;

        public KondukterProdajeViewModel(Kondukter selected, KondukterViewModel model)
        {
            view = KondukterProdajeView.view;
            this.model = model;
            ...
            if (!error)
            {
                try
                {
                    using (var db = new AutoprevoznikDBEntities())
                    {
                        ...
                        v.Kondukter.Kartas.Add(found);
                        found.Kondukters.Add(v.Kondukter);
                ...
                KondukterProdajeView.view.Close();
                model.RefreshList();
            }
        }
